...
public class AdditionGame extends Game {
	...
	public AdditionGame(Set<Question> questions, String title, int totalPoint) {
		super(questions, title, totalPoint);
	}

	@Override
	protected Question createQuestion() {
		// Single digit addition, i.e. between 0 - 9.
		...
		//Choice choice = question.createChoice(a, b, true);
		Choice choice = new Choice(question, String.valueOf(a + b), true);
